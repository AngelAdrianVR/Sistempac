...
const submit = () => {
    // Aquí defines la ruta de tu backend que procesará el formulario
    // form.post(route('contact.store'), {
    //     onSuccess: () => form.reset(),
    //     // También puedes manejar errores aquí
    // });
    alert('Formulario enviado (simulación). Conecta esto a tu backend.');
};
...
const contactInfo = [
    ...
    // { icon: 'location', text: 'Calle Falsa 123, Zapopan, Jalisco, México', href: '#' },
];
</script>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    >
                        ...
                        <div class="space-y-6">
                            <a v-for="info in contactInfo" :key="info.text" :href="info.href" class="flex items-start group">
                        ...
                        <!-- <div class="mt-10 rounded-lg overflow-hidden shadow-lg h-80">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.062835787134!2d-103.3919196850726!3d20.70732598622143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428af4b5b534d77%3A0x7ff7c3304b77f1f!2sZapopan%2C%20Jal.!5e0!3m2!1sen!2smx!4v1678886454321!5m2!1sen!2smx" 
                                width="100%" 
                                height="100%" 
                                style="border:0;" 
                                allowfullscreen="" 
