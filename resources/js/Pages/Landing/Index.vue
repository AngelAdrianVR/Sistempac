...
// La animación ahora se detiene y desvanece la imagen después del segundo punto.
...
const keyPointsLg = [
    ...
    // 2. Se mueve a la derecha, junto a la sección de Calidad, sigue visible
    { selector: '#calidad', styles: { top: 40, left: 30, scale: 1.4, rotate: -90, opacity: 1 } },
    // 3. Punto final: se mantiene en la posición de Calidad pero se desvanece
...
const handleScroll = () => {
    ...
    // --- Búsqueda del segmento de animación actual ---
    ...
    for (let i = 0; i < keyPoints.length - 1; i++) {
        ...
        const triggerY = nextPoint.isEnd
            ? (nextElem.offsetTop - windowHeight / 2) + 1 // Empieza a desvanecerse justo al pasar el punto de #calidad
    ...
    // Si ya pasamos el último punto, nos aseguramos de que la imagen esté oculta.
    ...
    // --- Cálculo del progreso e interpolación de estilos ---
    ...
    // El desvanecimiento ocurre en una distancia fija para ser más controlado.
    const endScroll = nextPoint.isEnd
        ? startScroll + 300 // La imagen se desvanece a lo largo de 300px de scroll
        : nextElem.offsetTop - windowHeight / 2;
    ...
    // --- Lógica para la opacidad de las características de calidad ---
    let featuresOpacity = 0;
    if (qualityFeatures.value) {
        if (prevPointIndex === 0 && nextPointIndex === 1) { // Transición de Hero a Calidad
            // Las características aparecen en la segunda mitad del trayecto
            featuresOpacity = Math.max(0, (progress - 0.5) * 2);
        } else if (prevPointIndex >= 1) { // Una vez en la sección de calidad o más allá
            // Las características permanecen 100% visibles
            featuresOpacity = 1;
        }
    }
        ...
        <div class="relative z-20 bg-white">
            ...
            <section id="hero" class="h-screen flex items-center">
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 class="text-4xl md:text-6xl font-extrabold text-blue-900 leading-tight mt-10">
            ...
            <section class="min-h-screen flex items-center bg-gray-50 py-20 overflow-hidden">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-start">
                    <div id="calidad" class="w-full md:w-1/2 text-left relative">
                        ...
                        <!-- Se eliminó el style="opacity: 0" para que JS lo controle -->
            ...
            <section id="variedad" class="min-h-screen flex items-center bg-white py-24">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p class="mt-4 text-gray-600 text-lg max-w-2xl mx-auto mb-12">
                        Explora nuestra amplia gama de productos de empaque, diseñados para ofrecerte la máxima calidad y eficiencia.
                    </p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div class="bg-gray-50 p-8 rounded-xl border border-gray-200 text-left transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
            ...
            <!-- Sección Soluciones (Rediseñada) -->
            <section id="soluciones" class="min-h-screen flex items-center bg-gray-50 py-24 overflow-hidden">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid md:grid-cols-2 gap-12 items-center">
                        <div class="text-left">
                            <span class="text-yellow-500 font-semibold">Soluciones Integrales</span>
                            <h2 class="text-3xl md:text-5xl font-bold text-blue-900 mt-2">Ingeniería de Empaque a tu Medida</h2>
                            ...
                            <ul class="mt-6 space-y-4 text-gray-700">
                                <li class="flex items-start"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-900 mr-3 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg><span>Análisis de la línea de producción.</span></li>
                                <li class="flex items-start"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-900 mr-3 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg><span>Selección de materiales óptimos.</span></li>
                                <li class="flex items-start"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-900 mr-3 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg><span>Pruebas de resistencia y durabilidad.</span></li>
                            </ul>
                        </div>
                        <div class="relative">
                            <img src="https://placehold.co/600x450/e2e8f0/1e3a8a?text=Soluciones+de+Empaque" alt="Ingeniero diseñando soluciones de empaque" class="rounded-xl shadow-2xl w-full h-auto z-10 relative">
            ...
            <section id="contacto" class="relative bg-white py-24 sm:py-32">
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <p class="mt-4 text-gray-600 text-lg max-w-2xl mx-auto">
                     ...
                     <a href="#" class="mt-8 inline-block bg-yellow-500 text-blue-900 font-bold py-3 px-8 rounded-full hover:bg-yellow-400 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-yellow-500/50">
